...
export function ContactFormCard({
  ...
  return (
    <Card className={arenaTheme.glassCard + " rounded-3xl py-0 shadow-none"}>
      <CardContent className="p-6 md:p-8">
        <h2 className="mb-8 text-3xl font-black tracking-tight text-white">Envie sua Mensagem</h2>
        ...
        <form className="space-y-6" onSubmit={onSubmit} noValidate>
          ...
          <div>
            ...
            <Textarea
              ...
              className={arenaTheme.input + " mt-1.5 min-h-56 resize-none"}
            />
          ...
          <Button
            ...
            className={arenaTheme.primaryButton + " h-14 w-full rounded-xl px-0 text-base"}
          >
